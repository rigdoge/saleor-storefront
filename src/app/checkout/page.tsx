		...
		<div className="min-h-dvh bg-white dark:bg-neutral-900">
			<section className="mx-auto flex min-h-dvh max-w-7xl flex-col p-8">
				<div className="flex items-center font-bold">
					<a aria-label="homepage" href="/" className="text-neutral-900 dark:text-white">
						ACME
					</a>
				</div>
				<h1 className="mt-8 text-3xl font-bold text-neutral-900 dark:text-white">Checkout</h1>
